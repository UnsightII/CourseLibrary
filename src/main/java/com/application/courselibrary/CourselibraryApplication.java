...
public class CourselibraryApplication {
	...
	public CommandLineRunner initialCreate(BookService bookService){
		return(args) ->{
			...
			Book book2 = new Book("ABC1", "Book name 2", "My second book");
			...
			Book book3 = new Book("ABC2", "Book name 3", "My third book");
			Author author3 = new Author("Test name3", "Test description");
			Category category3 = new Category("Programming books");
